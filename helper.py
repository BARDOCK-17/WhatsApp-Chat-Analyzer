...
def fetch_stats(selected_user, df):
    # Ensure case consistency with 'Overall'
    ...
    # Ensure the exact text matches '<Media omitted>'
...
def daily_timeline(selected_user, df):
    ...
    # Ensure 'only_date' is in datetime format
    df['only_date'] = pd.to_datetime(df['only_date'])
    
    # Group by 'only_date' and count messages
